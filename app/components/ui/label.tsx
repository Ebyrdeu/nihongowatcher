...
const labelVariants = cva(
    "cursor-pointer text-neutral-content text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70",
    {
        variants: {
            variant: {
                upload: "text-3xl flex flex-col items-center justify-center w-screen h-screen border-[3px] border-neutral-content hover:border-error transition duration-200 ease-in-out border-dashed  cursor-pointer",
                icon: "h-12 w-12",
            },
        },
    });
